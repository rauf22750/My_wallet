...
for(const file of ['index.html','style.css','app.js','ledger.js','cloud.js','session.js','reports.js','install.html','offline.html','pwa.js','sw.js','manifest.webmanifest']) await copyFile(file,`dist/${file}`);
